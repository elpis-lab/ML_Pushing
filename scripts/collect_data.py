...
from geometry.random_push import (
    ...
    # get_random_circular_push,
    get_cloud_point_push,
    generate_center_push_path,
)
...
def collect_data(obj_name, n_data, random_init=False, push_params=None):
    ...
    if push_params is None:
        ...
        # )
        # push_params, t_paths, ws_paths = get_random_circular_push(
            # n_data, init_states, obj_shape
        # )
        push_params, t_paths, ws_paths = get_cloud_point_push(
            n_data, init_states, obj_shape, obj_name
        )
    else:
        ...
        # )
        t_paths, ws_paths = generate_center_push_path(
            init_states, obj_shape, push_params
        )
